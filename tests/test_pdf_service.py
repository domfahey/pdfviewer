...
class TestPDFServiceMetadataExtraction:
    ...
    def test_extract_pdf_metadata_corrupted_file(self, mock_pdf_reader, sample_pdf_file):
    ...
    @patch('backend.app.services.pdf_service.PdfReader')
    def test_extract_pdf_metadata_with_metadata_validation_error(self, mock_pdf_reader, sample_pdf_file):

...
class TestLoadURL:
    ...
    async def test_load_pdf_from_url_success(self, async_client: AsyncClient):
        ...
        # Validate filename
        assert data["filename"] == "epa_sample_letter_sent_to_commissioners_dated_february_29_2015.pdf"
    ...
    async def test_load_invalid_url(self, async_client: AsyncClient):
        ...
        request_data = {
            "url": "https://invalid.example.com/notfound.pdf"
        }
    ...
    async def test_load_non_pdf_url(self, async_client: AsyncClient):
        ...
        assert "does not point to a PDF" in response.json()["detail"]
    ...
    async def test_load_all_sample_pdfs(self, async_client: AsyncClient):
            ...
            try:
                ...
                if response.status_code == status.HTTP_200_OK:
                    ...
                    if sample['expected_pages']:
                        assert data['metadata']['page_count'] == sample['expected_pages']
                else:
        ...
        for file_id in loaded_files:
            ...
            assert delete_response.status_code in [status.HTTP_200_OK, status.HTTP_404_NOT_FOUND]
    ...
    async def test_load_url_with_redirect(self, async_client: AsyncClient):
        ...
        request_data = {
            "url": self.SAMPLE_PDFS[3]['url']  # NHTSA URL often redirects
        }

...
class TestPerformance:
    ...
    async def test_upload_response_time(
        ...
        assert avg_response_time < 500, f"Average upload time {avg_response_time}ms exceeds 500ms"
    ...
    async def test_concurrent_upload_performance(
        ...
        print(f"  Throughput: {concurrent_uploads / (total_time / 1000):.2f} uploads/sec")
